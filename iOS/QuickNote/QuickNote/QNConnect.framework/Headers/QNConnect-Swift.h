...
SWIFT_CLASS("_TtC9QNConnect12QNConnection")
@interface QNConnection : NSObject
...
@property (nonatomic, strong) MCAdvertiserAssistant * _Nullable advertiser;
- (void)setupPeerIDAndSessionWith:(NSString * _Nonnull)displayName;
- (void)setupMCBrowser;
- (void)advertiseSelfWithShouldAdvertise:(BOOL)shouldAdvertise;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface QNConnection (SWIFT_EXTENSION(QNConnect)) <MCBrowserViewControllerDelegate>
...
@interface QNConnection (SWIFT_EXTENSION(QNConnect)) <MCSessionDelegate>
